...
RSpec.describe UserDetailsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all user_details as @user_details" do
      ...
      expect(assigns(:user_details)).to eq([user_detail])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested user_detail as @user_detail" do
      ...
      expect(assigns(:user_detail)).to eq(user_detail)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new user_detail as @user_detail" do
      ...
      expect(assigns(:user_detail)).to be_a_new(UserDetail)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created user_detail as @user_detail" do
        post :create, {:user_detail => valid_attributes}, valid_session
        expect(assigns(:user_detail)).to be_a(UserDetail)
        expect(assigns(:user_detail)).to be_persisted
      end

      it "redirects to the created user_detail" do
        post :create, {:user_detail => valid_attributes}, valid_session
        expect(response).to redirect_to(UserDetail.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved user_detail as @user_detail" do
        post :create, {:user_detail => invalid_attributes}, valid_session
        expect(assigns(:user_detail)).to be_a_new(UserDetail)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested user_detail" do
        user_detail = UserDetail.create! valid_attributes
        put :update, {:id => user_detail.to_param, :user_detail => new_attributes}, valid_session
        user_detail.reload
    ...
    context "with invalid params" do
      it "assigns the user_detail as @user_detail" do
        user_detail = UserDetail.create! valid_attributes
        put :update, {:id => user_detail.to_param, :user_detail => invalid_attributes}, valid_session
        expect(assigns(:user_detail)).to eq(user_detail)
      end
